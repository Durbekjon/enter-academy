        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td>
                    ...
                    <div
                        class="modal fade"
                        id="editSocialMediaAccountModal{{ $soc -> id}}"
                        tabindex="-1"
                        aria-labelledby="exampleModalLabel"
                        aria-hidden="true"
                    >
