            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-secondary navbar-dark">
                    <a href="/home" class="navbar-brand mx-4 mb-3">
                        <h3 class="text-primary"><span><img src="front/assets/img/enterzk.png" width="50"
                                    alt="" style="padding-right: 5px"></span> Enter-zk</h3>
                    </a>
                    <a href="showProfile">
                        <div class="d-flex align-items-center ms-4 mb-4">
                            <div class="position-relative">
                                <img class="rounded-circle" src="/user/{{ Auth::user()->img }}" alt=""
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="/message" class="nav-link dropdown-toggle"><i
                                class="far fa-file-alt me-2"></i>Messages</a>
                    ...
                    <div class="navbar-nav align-items-center ms-auto">
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                                <i class="fa fa-envelope me-lg-2"></i><sup class="bg-primary  text-hover"
                                    style="border-radius: 50%; padding:3px 8px; margin-left:-12px;">{{ $messageCount }}</sup>
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                                <img class="rounded-circle me-lg-2" src="user/{{ Auth::user()->img }}" alt=""
                                    style="width: 40px; height: 40px;">
            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-secondary navbar-dark">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="/teacher" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Teachers</a>
                        <a href="/newsPage" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>News</a>
                        <a href="/message" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                                class="far fa-file-alt me-2"></i>Messages</a>
                        <a href="/info" class="nav-link dropdown-toggle"><i
                                class="fa-solid fa-info me-2"></i>Info</a>
                    </div>
                </nav>
            </div>
            <!-- Sidebar End -->
