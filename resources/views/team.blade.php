            ...
            <div class="modal fade " id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content bg-secondary">
                        <div class="modal-body"> <h1 class="modal-title fs-5" id="exampleModalLabel">Add Team Member</h1><br>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{{ $t -> job }}</td>
                            @if (Auth::user()->admin == '1')
                                <td>
                                    <a href="/deleteTeam/{{ $t -> id}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                    ...
                                    <div class="modal fade" id="editModal{{ $t -> id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content bg-secondary">
                                            ...
                                            <div class="modal-body">
                                                <form action="/teamEdit/{{ $t -> id}}" method="post" enctype='multipart/form-data'>
                                                    @csrf
